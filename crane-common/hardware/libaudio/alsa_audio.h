...
#define PROP_AUDIO_OUT_MODE_KEY  	"media.audio.out.mode"
#define PROP_AUDIO_OUT_CODEC		"codec"
#define PROP_AUDIO_OUT_HDMI			"hdmi"
#define PROP_AUDIO_OUT_DEFAULT		PROP_AUDIO_OUT_CODEC
