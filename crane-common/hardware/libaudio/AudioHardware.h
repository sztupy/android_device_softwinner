...
public:
	...
	// add interfaces here
	virtual status_t	setAudioOutMode(unsigned int mode);
	virtual int			getAudioOutMode();
	virtual status_t	setAudioPaOnOff(bool status);
...
private:
	...
	int				mPaDevHandle;	// pa driver handle
